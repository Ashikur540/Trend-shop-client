...
export const Sale = () => {
    return (
        <motion.section id='summer-sale' className='w-full px-4 container py-12 lg:py-20 my-10' initial="initial" animate="animate">
            <div
                ...
                <motion.img
                    ...
                    className="w-full max-h-[500px] object-cover " alt='summer_sale' variants={heroImagescaleUp} />
                ...
                >
                    <motion.h2 className="text-3xl md:text-4xl font-bold uppercase text-slate-50"
                    ...
                    <Link to="/products">
                        <motion.button to="/products" className="rounded-none  text-sm px-5 py-4 text-center text-[#FF965C] bg-white hover:bg-[#eeeceb]  font-medium flex justify-between items-center gap-8"
                            initial={{ x: -100, opacity: 0, }}
                            whileInView={{ x: 0, opacity: 100 }}
                            transition={{
                                delay: 0.3,
