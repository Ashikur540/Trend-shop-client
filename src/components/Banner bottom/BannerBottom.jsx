    ...
    return (
        <section className='py-4 w-full  relative'>
            <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row justify-between flex-wrap  gap-4 items-center px-8">
                ...
                <button className="rounded-none w-full sm:w-full  max-w-full md:w-full lg:w-auto xl:w-auto  py-6 px-10 bg-black text-white font-medium flex justify-between items-center gap-8">Save Changes
                    <span>
